...
export function apiCompaniesCompanyIdReportingsPost$Json(http: HttpClient, rootUrl: string, params: ApiCompaniesCompanyIdReportingsPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<ReportingDto>> {
