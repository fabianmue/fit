...
export function getCompany(http: HttpClient, rootUrl: string, params: GetCompany$Params, context?: HttpContext): Observable<StrictHttpResponse<CompanyReadDto>> {
