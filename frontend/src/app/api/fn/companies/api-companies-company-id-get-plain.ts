...
export function apiCompaniesCompanyIdGet$Plain(http: HttpClient, rootUrl: string, params: ApiCompaniesCompanyIdGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<CompanyDto>> {
