...
export function apiCompaniesPost$Json(http: HttpClient, rootUrl: string, params: ApiCompaniesPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<CompanyDto>> {
