...
export function apiCompaniesCompanyIdPut(http: HttpClient, rootUrl: string, params: ApiCompaniesCompanyIdPut$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
